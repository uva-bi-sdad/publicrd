...
for topic in topic_vec:
    ...
    !location = /project/biocomplexity/sdad/projects_data/ncses/prd/Dynamic_Topics_Modelling/NMF/
    !python find-window-topics.py *.pkl -k topic,topic -o location/out
    
    # Solve for NMF-DTM
    # number of topics for the 2nd step k=30 
    !python find-dynamic-topics.py Term_docs_2008_windowtopics_k30.pkl Term_docs_2009_windowtopics_k30.pkl Term_docs_2010_windowtopics_k30.pkl Term_docs_2011_windowtopics_k30.pkl Term_docs_2012_windowtopics_k30.pkl Term_docs_2013_windowtopics_k30.pkl Term_docs_2014_windowtopics_k30.pkl Term_docs_2015_windowtopics_k30.pkl Term_docs_2016_windowtopics_k30.pkl Term_docs_2017_windowtopics_k30.pkl Term_docs_2018_windowtopics_k30.pkl Term_docs_2019_windowtopics_k30.pkl -k topic,topic -o /out
