...
noNAcondistrict <- (nrow(fed_reporter) - sum(is.na(fed_reporter$CONGRESSIONAL_DISTRICT)))
...
noNAbudgetstartdate <- (nrow(fed_reporter) - sum(is.na(fed_reporter$BUDGET_START_DATE)))
...
noNAbudgetenddate <- (nrow(fed_reporter) - sum(is.na(fed_reporter$BUDGET_END_DATE)))
