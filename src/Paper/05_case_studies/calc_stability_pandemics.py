...
df = pd.read_pickle("/project/biocomplexity/sdad/projects_data/ncses/prd/Paper/case_studies/pandemic_corpus.pkl")
...
stability_df.to_csv('/project/biocomplexity/sdad/projects_data/ncses/prd/pandemics_stability_measures_paper.csv', index = False)
