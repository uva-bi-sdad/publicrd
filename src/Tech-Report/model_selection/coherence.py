...
df_topics = pd.read_pickle("./results/LDA/lda_topics3-5.pkl")
...
for j in range(ncol):
    ...
    for i in range(nrow): 
        ...
        # calculate coherence
        t1 = time.time()
        cm = CoherenceModel(topics=df_topics.iloc[i,j], dictionary=id2word, texts=docs, coherence='c_v', processes=30) 
...
co_val.to_pickle("./results/coherence/co_lda_val3-5.pkl")
co_t.to_pickle("./results/coherence/co_lda_t3-5.pkl")
